<h1>CMS Wiki</h1>
CMS Wiki - это беспланый движок для вики сайта, созданный на базе Laravel и базы данных MySQL. 
Особенности установки:
1. Обязательна регистрация главного пользователя под логином admin.
2. На старте нужно импортировать дамп базы данных, расположенного в каталоге /public, файл называется CMSwiki.sql
3. Также нужно прописать данные для подключения к базе данных в файле .env
